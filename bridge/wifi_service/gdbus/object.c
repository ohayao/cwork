...
// message_function: 	Function to handle messages.
...
// 如何添加这些Interface?
// get_objects -> append_object -> append_interfaces
...
// 对路径的数据结构进行获取, 如果每有, 新建一个
// 并且添加一个 Introspect 数据接口
							...
							const char *path)
{
	...
	// 提那家一个接口
	// DBUS_INTERFACE_INTROSPECTABLE 接口
	// 提供一个 introspect 的数据反法
...
// g_dbus_attach_object_manager 的主要作用
// 
